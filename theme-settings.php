 ...
 */
function uwmbase_form_system_theme_settings_alter(&$form, \Drupal\Core\Form\FormStateInterface &$form_state, $form_id = NULL) {
  ...
  $form['uwmbase_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('uwmbase sample setting'),
  '#default_value' => theme_get_setting('uwmbase_example'),
